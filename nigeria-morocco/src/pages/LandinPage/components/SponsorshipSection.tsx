...
export default function SponsorshipSection() {
  ...
  const packages = useMemo(
    () => [
      {
        icon: <img src="/platinum.svg" alt="Platinum" className="w-10 h-10" />,
        title: t("Platinum", { defaultValue: "Platinum" }),
        price: "₦3,000,000",
        features: [
          t("speakingOpportunity", { defaultValue: "Speaking opportunity" }),
          t("vipAccess", { defaultValue: "VIP access" }),
          t("maximumBrandVisibility", {
            defaultValue: "Maximum brand visibility",
          }),
          t("primeBoothLocation", { defaultValue: "Prime booth location" }),
        ],
        color: "blue",
      },
      {
        icon: <img src="/gold.svg" alt="gold" className="w-10 h-10" />,
        title: t("Gold", { defaultValue: "Gold" }),
        price: "₦2,000,000",
        features: [
          t("premiumBoothSpace", { defaultValue: "Premium booth space" }),
          t("panelParticipation", { defaultValue: "Panel participation" }),
          t("networkingEvents", { defaultValue: "Networking events" }),
          t("logoPlacement", { defaultValue: "Logo placement" }),
        ],
        color: "yellow",
      },
      {
        icon: <img src="/silver.svg" alt="silver" className="w-10 h-10" />,
        title: t("Silver", { defaultValue: "Silver" }),
        price: "₦1,500,000",
        features: [
          t("standardBooth", { defaultValue: "Standard booth" }),
          t("eventAccess", { defaultValue: "Event access" }),
          t("brandInclusion", { defaultValue: "Brand inclusion" }),
          t("marketingMaterials", { defaultValue: "Marketing materials" }),
        ],
        color: "gray",
      },
    ],
    ...
    <div className="w-full bg-gradient-to-b from-gray-50 to-white py-20 px-4">
      <div className="max-w-7xl mx-auto mb-24">
        <h2 className="text-3xl font-bold text-center text-gray-900 mb-4">
          {t("SponsorshipPackage", { defaultValue: "Sponsorship Package" })}
        </h2>
        ...
        <div className="flex justify-center">
          <button className="px-8 py-3 bg-white border-2 border-green-500 text-green-600 rounded-lg font-medium hover:bg-green-50 transition-all duration-200 text-base">
            {t("DownloadSponsorshipProspectus", {
              defaultValue: "Download Sponsorship Prospectus",
            })}
          </button>
        </div>
      </div>
      ...
      <div className="max-w-7xl mx-auto">
        <h2 className="text-3xl font-bold text-center text-gray-900 mb-4">
          {t("Our2024Sponsors", { defaultValue: "Our 2024 Sponsors" })}
        </h2>
