...
import { EnvironmentOutlined, PhoneOutlined, MailOutlined, TwitterOutlined, InstagramOutlined, LinkedinOutlined } from '@ant-design/icons';
            ...
            <div className="max-w-6xl mx-auto px-5 py-16">
                <div className="rounded-lg p-8 ">
                    ...
                    <div className="text-center mb-10">
                        <h2 className="text-3xl font-bold text-gray-900 mb-3">We Love to Hear from You.</h2>
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                        ...
                        <div className="space-y-6">
                            ...
                            <div className="bg-[#AAD4791A] shadow-sm rounded-lg p-6">
                                <h3 className="text-xl font-bold text-gray-900 mb-4">Nigeria Office</h3>
                                <div className="space-y-4">
                                    <div className="flex items-start gap-3">
                                        <EnvironmentOutlined className="text-lg text-gray-600 mt-1" />
                                        <span className="text-gray-700">No 1 Garki Layout, Abuja</span>
                                    </div>
                                    ...
                                    <div className="flex items-center gap-3">
                                        ...
                                        <span className="text-gray-700 text-sm">info@nigeria-moroccobusinessweek.com</span>
                                    </div>
                                    <div className="flex gap-3 mt-4">
                                        <a href="#" className="w-8 h-8 bg-black rounded flex items-center justify-center hover:bg-gray-800 transition">
                            ...
                            <div className="bg-[#F6CECE2B] rounded-lg p-6">
                                <h3 className="text-xl font-bold text-gray-900 mb-4">Morocco Office</h3>
                                <div className="space-y-4">
                                    <div className="flex items-start gap-3">
                                        <EnvironmentOutlined className="text-lg text-gray-600 mt-1" />
                                        <span className="text-gray-700">No 1 Garki Layout, Abuja</span>
                                    ...
                                    <div className="flex items-center gap-3">
                                        <MailOutlined className="text-lg text-gray-600" />
                                        <span className="text-gray-700">moroccobusinessweek.com</span>
                                    </div>
                                    <div className="flex gap-3 mt-4">
                                        <a href="#" className="w-8 h-8 bg-black rounded flex items-center justify-center hover:bg-gray-800 transition">
                                            <TwitterOutlined className="text-white" />
