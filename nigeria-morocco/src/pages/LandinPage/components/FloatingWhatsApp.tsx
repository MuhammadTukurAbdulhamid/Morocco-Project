...
const FloatingWhatsApp: React.FC = () => {
    return (
        <a href="https://wa.me/212649397662" target="_blank" rel="noopener noreferrer" className="fixed bottom-6 right-6 z-50 bg-green-500 hover:bg-green-600 text-white rounded-full shadow-lg p-4 flex items-center justify-center animate-bounce" aria-label="Contact us on WhatsApp">
